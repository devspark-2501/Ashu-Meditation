    ...
    return (
        ...
        >
            ...
            <p className="mt-8 text-center text-sm text-gray-500">
                ...
                <a href="/signup" className="font-semibold text-[#0E5D37] hover:underline">
                    Create one
                </a>
            </p>
        </motion.div>
...
function LoginFormFallback() {
    return (
        <div className="flex w-full max-w-md items-center justify-center rounded-3xl border border-[#0E5D37]/10 bg-white/80 p-10 shadow-[0_8px_40px_rgba(14,93,55,0.08)] backdrop-blur-xl">
            <Loader2 className="h-6 w-6 animate-spin text-[#0E5D37]" />
        </div>
    );
}
